...
package ReseqTrack::HiveProcess::RunVariantCall::CallBySamtools;

use strict;

use base ('ReseqTrack::HiveProcess::BranchableProcess');
use ReseqTrack::Tools::RunVariantCall::CallBySamtools;
...
sub run {
    ...
    my $variant_caller = ReseqTrack::Tools::RunVariantCall::CallBySamtools->new(
          -input_files => $bam,
          -program => $self->param('samtools'),
          -bcftools => $self->param('bcftools'),
          -vcfutils => $self->param('vcfutils'),
